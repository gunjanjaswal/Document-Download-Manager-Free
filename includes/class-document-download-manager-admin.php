...
class Document_Download_Manager_Admin {
    ...
    public function enqueue_scripts() {
        ...
        if (isset($_GET['page']) && isset($_GET['_wpnonce']) && 
            ...
            wp_verify_nonce(sanitize_text_field(wp_unslash($_GET['_wpnonce'])), 'docdownman_email_marketing')) {
            $api_key_script = "
        ...
        <div class="wrap">
            ...
            <div class="docdownman-instructions">
                ...
                <ol>
                    ...
                    <li>Alternatively, you can use the shortcode with a custom button text: <code>[docdownman_document_download id="file-id" text="Free Download"]</code></li>
                </ol>
